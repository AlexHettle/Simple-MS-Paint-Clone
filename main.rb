...
chosen_color="black"
#startng eraser color
erase_color="white"
#list of colors used when user chooses a new color
color_list=['red','orange','yellow','green','blue','#EE82EE','black','#808080','white']
draw_size=10
#creates all buttons for colors
...
#creates the eraser, paint bucket, increase and decrease buttons
...
#When mouse is clicked, this chunk of code determines where the click was, and determines
#how to handle the 
on :mouse_down  do |event|
  if event.x>50 && event.x<430 && event.y>15 && event.y<445
